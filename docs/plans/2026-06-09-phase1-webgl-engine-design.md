...
3. **M3 — Editor flag.** 🚧 Implementation landed 2026-06-09 (plan: docs/plans/2026-06-09-phase1-m3-editor-flag-plan.md); dogfooding IN PROGRESS per docs/plans/2026-06-09-phase1-m3-dogfooding-checklist.md. usePlaybackEngineGL behind `comfynext:Engine.WebGLPreview` (default off), Canvas2D auto-fallback, kinetic/title/sequence/audio wired, per-clip skip-and-warn, WebCodecs size cap, video loop parity with the exporter, harness pages dev-gated.
