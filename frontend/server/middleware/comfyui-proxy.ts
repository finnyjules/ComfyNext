...
const NITRO_API_PATHS = ['/api/explain', '/api/pipeline-suggest', '/api/secrets', '/api/render-template', '/api/lora-preview', '/api/replicate-cover', '/api/google-fonts', '/api/loras-local', '/api/lora-cover', '/api/community-workflow']
const NITRO_API_PREFIXES = ['/api/templates', '/api/cloud-train', '/api/krea', '/api/vector', '/api/inpaint', '/api/brand-kits', '/api/template-fonts']
