...
const GENERATORS: AgentCapability[] = [
  ...
  { nodeType: 'FluxMultiLoRARemoteNode', kind: 'generator', title: 'Generate with two LoRAs', summary: 'Stack two LoRAs (character + style) in one Flux generation.', inputs: [], outputs: IMG,
